...
(: set-dir : Direction Turtle -> Turtle)
;; set the direction of the turtle to dir
(define (set-dir dir turtle)
  (match turtle
    [(Turtle pos _ pen surf) (Turtle pos dir pen surf)]))
...
(provide
  ...
  forward
  turn
  (rename-out [Turtle-dir get-dir])
  set-dir
  (rename-out [Turtle-pos get-pos])
  move-to
  move-by
  get-image)
