...
(: uc151image-version : String)
(define uc151image-version "1.0")
(provide uc151image-version)

(: uc151image-date : String)
(define uc151image-date "September 26, 2016")
(provide uc151image-date)
...
(: uchicago151-circle : Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle : Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-square : Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-rectangle : Real Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-ellipse : Real Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-line : Real Real (U Pen Image-Color) -> Image)
(define (uchicago151-line a b color)
  (line a b (cast color (U Pen Image-Color))))
(provide (rename-out [uchicago151-line line]))

(: uchicago151-add-line : Image Real Real Real Real (U Pen Image-Color) -> Image)
...
(: uchicago151-add-curve : Image Real Real Angle Real Real Real Angle Real (U Pen Image-Color) -> Image)
...
(: uchicago151-add-solid-curve : Image Real Real Angle Real Real Real Angle Real (U Pen Image-Color) -> Image)
...
(: uchicago151-right-triangle : Real Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-isosceles-triangle : Real Angle (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle/sss : Real Real Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle/ass : Angle Real Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle/sas : Real Angle Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle/ssa : Real Real Angle (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle/aas : Angle Angle Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle/asa : Angle Real Angle (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-triangle/saa : Real Angle Angle (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-rhombus : Real Angle (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-star : Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-star-polygon : Real Integer Integer (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-radial-star : Integer Real Real (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-regular-polygon : Real Integer (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-polygon : (Listof Posn) (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-add-polygon : Image (Listof Posn) (U String Mode) (U Pen Image-Color) -> Image)
...
(: uchicago151-scene+polygon : Image (Listof Posn) (U String Mode) (U Pen Image-Color) -> Image)
