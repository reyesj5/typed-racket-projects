...
;; Added values for specular coefficients and sharpness
;;
...
;; tests for reflective materials
;;
(define (specular? mat)
  (< 0 (Material-sharp mat)))
(check-expect (specular? (make-diffuse (RGB 5 5 5))) #f)
(check-expect (specular? (Material (RGB 5 5 5) (RGB 0 0 0) -5)) #f)
(check-expect (specular? (Material (RGB 5 5 5) (RGB 0 0 0) 5)) #t)
